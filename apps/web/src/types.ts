...
export type NationalPortDashboardResponse={provider:"VIMAWA";sourceKind:"OFFICIAL_GOV";sourceUrl:string;status:"NORMALIZED"|"PARTIAL";latestPeriod:string|null;latest:NationalDashboardPoint[];series:NationalDashboardPoint[];trend:{availableYears:number[];latestYear:number|null;points:NationalTrendPoint[];note:string};reports:Array<{title:string;period:string|null;publishedDate:string|null;pageUrl:string;xlsxUrl:string|null}>;note:string;serverTime:string};
